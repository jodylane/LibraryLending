...
<section class="login">
    <form action="sendlogin.php" method="post">
        ...
        <a href="index.php"><button type="button" class="btn btn-danger" formnovalidate>Cancel</button></a>
        <input type="submit" class="btn btn-success" value="Log In">
        <p>Don't have an account with us? Sign up now!</p>
        <a href="signup.php"><button type="button" class="btn btn-info" formnovalidate>Signup</button></a>
    </form>
</section>
<?php
