...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2016 at 03:29 AM
...
INSERT INTO `users` (`user_id`, `user_name`, `first_name`, `last_name`, `user_email`, `password`) VALUES
(1, 'lukebrown', 'Luke', 'Brown', 'lukbrown@iupui.edu', 'password'),
(2, 'bookfan0001', 'Bill', 'Smith', 'bsmith@example.com', 'password'),
(3, 'ilovebooks', 'Sarah', 'Wood', 'swood@example.com', 'password'),
(4, 'reedread', 'Taylor', 'Reed', 'reedreader@example.com', 'password'),
(5, 'marklibrary', 'Mark', 'Jackson', 'mjack@example.com', 'password'),
(6, 'taeadsf', 'Luke', 'Brown', 'lukbrown@iupui.edu', 'password');
